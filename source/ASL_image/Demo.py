...
model_path = r'D:\SLA\vgg16_best_model.pth'
...
if cap.isOpened():
    while True:
        ...
        camera_feed.image(img, channels="BGR", width=400)
        processed_feed.image(cv2.cvtColor(img_crop_resized, cv2.COLOR_BGR2RGB), channels="RGB", width=400)
