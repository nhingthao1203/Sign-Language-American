...
model.classifier[6] = torch.nn.Linear(model.classifier[6].in_features, 35)  # 35 output classes

model_path = r'D:\Sign-Language-To-Text\Sign-Language-To-Text\vgg16_best_model.pth'
try:
